...
foreach ($elementarray as $elementrow) {
	...
	// limit availability display and booking to allow only the selected property id....
	if (($content_source == 7 || $content_source == 9) && $elementrow['resource_id'] > 0) $selected_id = $elementrow['resource_id'];
}
if ($content_source == 0) {
