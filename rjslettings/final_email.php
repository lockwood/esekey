<?php
// +----------------------------------------------------------------------+
// | DEPOSIT_EMAIL  - final confirmation email formatter for RJS Lettings (co 7)|
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id: 7/final_email.php,v 1.02 2006/01/17
//
...
<p>';
if ($viewrow['property_name'] == '26 New Road')
{
	$email_tail_text = '
The full address of the property is 26 New Road, Holyport, Maidenhead, Berkshire, SL6 2LQ.
...
{
	$email_tail_text = '
The full address of the property is Primrose House, 2 Hill Hay Close, Fowey, Cornwall PL23 1EN.
...
/* additional headers */
$headers .= "From: RJS Lettings <bookings@rjslettings.co.uk>\r\n";
