<?php
// +----------------------------------------------------------------------+
// | GALLERY  - displays image gallery for Company 7                      |
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id: 7/gallery.php,v 1.01 2006/01/17
//
...
if ($exhibit > 0) {
    $prev = $exhibit - 1;
    $prevlink = '<b><a href="'.$page_name.'_page.php?exhibit='.$prev.'"><font color=black><<&nbsp;Prev</font></a></b>';
} else {
    $prevlink = '<span style="color: silver"><<&nbsp;Prev</span>';
}
$galleryrow = $filearray[$exhibit];
if ($filearray[$next] != null) {
    $nextlink = '<b><a href="'.$page_name.'_page.php?exhibit='.$next.'"><font color=black>Next&nbsp;>></font></a></b>';
} else {
...
?>
<br>
<form action="<?=$page_name?>_page.php" name="frmExhibit" id="frmExhibit" method="get">
...
if ($galleryrow[image_name] !=null) {?>
  <tr>
    <td colspan="3" style="text-align: center"><IMG src="<?=$img_prefix.$galleryrow[image_name]?>" width=350 border="1"></td>
  </tr><?php 
} ?>
</table>
</form>
