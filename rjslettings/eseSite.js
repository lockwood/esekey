...
// +----------------------------------------------------------------------+
//
// $Id: esesite.js, V1.01 2009/05/03
//

function DoPopup(serverName, selectedId) {

      var targetUrl = 'https://' + serverName + '/rjslettings/idxs.php?p=6&conditions=Accept&property=' + selectedId;
