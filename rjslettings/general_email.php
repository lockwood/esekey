<?php
// +----------------------------------------------------------------------+
// | GENERAL_EMAIL  - general email formatter for RJS Lettings (co 7)     |
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id: 7/general_email.php,v 1.00 2006/11/22
//
...
/* additional headers */
$viewrow['email_headers'] .= "From: RJS Lettings <bookings@rjslettings.co.uk>\r\n";
