...
while ($month_count <= 3) { ?>
  ...
  <?php
  while (isset($datearray[$i]) && ($datearray[$i]['booking_month'] == $c_month)) { ?>
    <td>
      <table width="100%" border="0" cellspacing="1" cellpadding="0"><?php
      if ($disp_year > 0) { 
          if ($month_count == 1) { ?> 
      ...
      <?php
        ...
        while (($fullname == $c_name) && (isset($datearray[$i])) && ($datearray[$i]['booking_month'] == $c_month)) {
        ...
        <tr>
            ...
            } elseif ($datearray[$i]['display_status'] == 'E' && isset($start_booking) && $_SESSION[$ss]['booking_flag'] == 'Y') {
