...
function columnControls() {
	...
	jQuery(".column .column .column_popup").live("click", function(e) {
		...
		if (answer) {
			jQuery(this).closest(".column").insertBefore('.wpb_main_sortable div.clear:last');
			initDroppable();
			save_composer_html();
		}
	});
...
function getTinyMceHtml(obj) {
	var mce_id = obj.attr('id'),
		...
		if (obj.closest(".edit_form_line").find(".wpb_media-buttons a.wpb_switch-editors").text() == "Visual mode") {
...
function getElementMarkup (target, element, action) {
	...
	jQuery.ajax({
		...
		success: function(msg) {
			...
			/* Make sure to insert new element before div.clear */
			if (jQuery(target).hasClass('wpb_main_sortable')) {
				jQuery(msg).insertBefore('.wpb_main_sortable div.clear:last');
			} else {
...
function wpbTabsEditCallBack(id) {
	...
	element.find(".ui-tabs-nav li").each(function(index) {
		...
		html += '<div class="edit_form_line">\
						...
						'+upload_media_btns+'\
						<textarea name="tab_content-'+index+'" class="tab_content wpb-textarea visual_composer_tinymce">'+tab_content+'</textarea>\
	...
	jQuery('.tab_add_tab').click(function(e) {
		...
		html += '<div class="edit_form_line">\
						<label for="tab_content-'+index+'">Tab content</label>\
						'+upload_media_btns+'\
						<textarea name="tab_content-'+index+'" class="tab_content wpb-textarea visual_composer_tinymce"></textarea>\
						<span class="description">Tab content.</span>\
					</div>';
		html += delete_edit_row;
		html += '<hr class="divider" />';
...
function wpbTabsSaveCallBack(id) {
	...
	jQuery('#visual_composer_edit_form .tab_section').each(function(index) {
		...
		html_back = getTinyMceHtml(jQuery(this).find('.tab_content'));
...
function wpbTourEditCallBack(id) {
	...
	element.find(".wpb_tour_slide").each(function(index) {
		...
		html += '<div class="edit_form_line">\
						...
						'+upload_media_btns+'\
						<textarea name="slide_content-'+index+'" class="slide_content wpb-textarea visual_composer_tinymce">'+slide_content+'</textarea>\
	...
	jQuery('.tab_add_tab').click(function(e) {
		...
		html += '<div class="edit_form_line">\
						<label for="slide_content-'+index+'">Slide content</label>\
						'+upload_media_btns+'\
						<textarea name="slide_content-'+index+'" class="slide_content wpb-textarea visual_composer_tinymce"></textarea>\
						<span class="description">Slide content.</span>\
					</div>';
		html += delete_edit_row;
		html += '<hr class="divider" />';
...
function wpbTourSaveCallBack(id) {
	...
	jQuery('#visual_composer_edit_form .slide_section').each(function(index) {
		...
		html_back = getTinyMceHtml(jQuery(this).find('.slide_content'));
		// destroy tinyMCE editor
		tinyMCE.execCommand('mceRemoveControl', false, mce_id);
		//
		//if (tab_title != '') {
