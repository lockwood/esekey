...
<meta name="copyright" content="Esekey Limited 2005-13, All Rights Reserved" />
<title>
<?php if (is_home()) {
	echo bloginfo('name');
} elseif (is_category()) {
...
<link rel="stylesheet" href="http://www.troppo.uk.com/dsca/wp-content/themes/dandelion/css/booking.css" type="text/css" media="screen" charset="utf-8" />
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/script/eseBooking.js"></script>
