<?php
// +----------------------------------------------------------------------+
// | RESERVE  - EseSite booking reservation - Company 3                   |
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id: 3/reserve.php,v 1.09 2006/11/25
//
...
$apartment = '';
if (isset($r[1])) {
    $apartment .= 'Wisteria<br>';
}
if (isset($r[2])) {
    $apartment .= 'Gardener&#039;s Bothy<br>';
}
if (isset($r[3])) {
    $apartment .= 'The Smithy<br>';
}
if (isset($r[4])) {    $apartment .= 'Flo&#039;s Cabin<br>';}$_SESSION[$ss]['apartment'] = $apartment;
