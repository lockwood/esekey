...
<p>';
$email_tail_text = 'Should you require any specific sleeping or bedding arrangements, please ensure that we are informed before your stay.  
A further email, including directions to Dorney Self Catering Apartments, will be sent when the balance payment is processed. 
The balance will be taken automatically using the card details you supplied when you booked, unless otherwise specified. 
