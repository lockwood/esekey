...
if ($_SESSION[$ss]['permissions'] == '') {
    ...
    $_SESSION[$ss]['menu'][$menuHeading][0][6] = 'Gallery List';	
    $_SESSION[$ss]['menu'][$menuHeading][1][6] = 'list.php?view=gallery&';	
    $_SESSION[$ss]['menu'][$menuHeading][0][7] = 'Page Statistics';	
    $_SESSION[$ss]['menu'][$menuHeading][1][7] = 'pagestats.php?';	
}	
