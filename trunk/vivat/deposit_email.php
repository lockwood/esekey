<?php
// +----------------------------------------------------------------------+
// | DEPOSIT_EMAIL  - deposit paid email formatter for Vivat (co 5)       |
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id: 5/deposit_email.php,v 1.00 2005/02/09
//
...
<p>';
$email_tail_text = 'A further email, including directions to the property you have booked, will be sent when the balance payment is processed. 
