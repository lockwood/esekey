<?php
// +----------------------------------------------------------------------+
// | Properties - initialisation of EseSite runtime driver - Company 10   |
// +----------------------------------------------------------------------+
...
// $_test = '_test';
if ($_SERVER['SERVER_NAME'] == 'dlockwood' || $_SERVER['SERVER_NAME'] == 'localhost') { // test environment variables
    // Environment - test
    $env = 'test';
    // $_test = '_test';
    ...
    // Server Name - test
    $servername = $_SERVER['SERVER_NAME'].'/esekey';
