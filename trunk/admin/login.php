	...
	if(!$_POST['username'] | !$password) {
      ...
      if ($_SESSION[$ss]['error_message'] == null) {
	    ...
	    $_SESSION[$ss]['permissions'] = $info['permissions'];
          ...
          header("Location: https://".$servername."/admin/goto_main.php");
      }
} else {
...
function CheckLogin() {
	...
	if (objPassword.value == '') {
      ...
      if (objUsername.value =='caroline') {
          document.loginform.action = 'https://securesslhost.net/~esekey9/admin/login.php';
      }
      if (objUsername.value =='adminuk') {
          document.loginform.action = 'https://securesslhost.net/~esekey9/admin/login.php';
      }
