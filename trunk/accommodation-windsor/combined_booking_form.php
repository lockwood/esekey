...
// +----------------------------------------------------------------------+
//
// $Id: 8/combined_booking_form.php,v 1.04 2006/02/06
//
...
if (count($resourcearray) == 1) { // Select single property by default
	$full_name = '';
	if ($resourcearray[0]['property_number'] != ''){
		$full_name = $resourcearray[0]['property_number']." ";
	}
	$full_name .= $resourcearray[0]['property_name'];
 ?>
          <tr>
            <td align="right" nowrap class="input">Location: <?=$full_name?></td>
            <td align="left">
...
<?php
	...
	?>
          <tr>
            <td align="right" nowrap class="input"><b>Location: <?=$full_name?></b></td>
            <td align="left"><b>
...
<?php   
	} else
	{
		...
		foreach ($resourcearray as $propertyrow) { 
			...
			?>
          <tr>
            <td align="right" nowrap class="input"><?=$full_name?></td>
            <td align="left">
...
?>
    ...
    <?php
          ...
          ?>
                  ...
                  <td align="right" valign="top" class="input"><b>&pound;<?=number_format($deposit,2)?></b></td>
                </tr>
                <tr>
                  <td class="input"><b>Balance <br>(due <?=$balance_due?>arrival):</b></td>
                  <td align="right" valign="top" class="input"><b>&pound;<?=number_format($balance,2)?></b></td>
                </tr>
                <tr>
                  <td nowrap class="input"><b>Total Price:</b></td>
                  <td align="right" class="input"><b>&pound;<?=number_format($price,2)?></b></td>
          <?php
    ...
    <tr>
      ...
      <?php
      if (!isset($error1)) { ?>
      <td class="input" align="right">&nbsp;Agreed&nbsp;Price&nbsp;&pound;<input type="text" class="input" name="ap" size="10" maxlength="8" value="<?=$ap?>"></td>
      <?php 
      } ?>
    </tr>
    <?php
