<?php
// +----------------------------------------------------------------------+
// | GENERAL_EMAIL  - general email formatter for Accom Windsor (co 9)    |
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id: 9/general_email.php,v 1.00 2007/02/01
//
...
/* additional headers */
$viewrow['email_headers'] .= "From: Accommodation Windsor <bookings@almahouse.co.uk>\r\n";
