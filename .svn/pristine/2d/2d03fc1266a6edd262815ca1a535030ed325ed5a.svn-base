<?php
// +----------------------------------------------------------------------+
// | GENERAL_EMAIL  - general email formatter for Troppo (co 3)           |
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id: 3/general_email.php,v 1.00 2006/11/22
//
...
Tel: 01753 827037 
Fax: 01753 855022 
Email: enquiries@troppo.uk.com 
Web: http://www.troppo.uk.com 
...
/* additional headers */
$viewrow['email_headers'] .= "From: Dorney Self Catering Apartments <bookings@troppo.uk.com>\r\n";
