<?php
// +----------------------------------------------------------------------+
// | EMAIL  - EseSite booking confirmation email formatter - Company 9    |
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id:accommodation-windsor/email.php,v 1.00 2007/02/01
//
...
//  echo $insert; //
	...
	$trackhdr .= "From: Accommodation Windsor Admin <admin@almahouse.co.uk>\r\n";
