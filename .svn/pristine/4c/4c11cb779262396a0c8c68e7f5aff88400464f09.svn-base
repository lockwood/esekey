...
// new winter tariff for 2011-12 (updated for 2014-15)
$winter_nights = 0;
if ($end_date > '2014-10-31' && $start_date < '2015-03-01') {
	// winter tariff may apply
	$day = $start_date;
	for ($i=0;$i<$n;$i++) {
		if ($day > '2014-10-31' && $day < '2014-12-19') {
			$winter_nights++;
		}
		if ($day > '2015-01-02' && $day < '2015-03-01') {
			$winter_nights++;
		}
...
if (isset($o[3])) {
	$price = $price + $dog_rate;
	$additional_info .= 'Includes £'.$dog_rate.' pet supplement.<br>';
}
if ($lp > 0) {
