<?php
// +----------------------------------------------------------------------+
// | EMAIL  - EseSite booking confirmation email formatter - Company 11    |
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id: 11/email.php,v 1.00 2008/03/09
//
...
/* additional headers */
$headers .= "From: Pebble Villa <bookings@pebblevilla.co.uk>\r\n";
...
//  echo $insert; //
    ...
    $trackhdr .= "From: Pebble Villa Admin <admin@pebblevilla.co.uk>\r\n";
