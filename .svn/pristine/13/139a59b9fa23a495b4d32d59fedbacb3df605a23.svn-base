<?php
// +----------------------------------------------------------------------+
// | DEPOSIT_EMAIL  - deposit paid email formatter for Troppo (co 3)      |
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id: 3/deposit_email.php,v 1.00 2005/01/21
//
...
<body>
<p>';
$email_top_text = 'Dear '.$viewrow[title].' '.$viewrow[last_name].'
...
<p>';
$email_tail_text = 'A further email, including directions to Mapledurham Estate, will be sent when the balance payment is processed. 
This should arrive approximately 4 weeks before your arrival is due. In the meantime, if you have any queries, please do not hesitate to contact us.</p>
';
$email_tail = '</p>
</body>
</html>
...
/* additional headers */
$headers .= "From: Mapledurham Holiday Cottages <bookings@mapledurham.co.uk>\r\n";
