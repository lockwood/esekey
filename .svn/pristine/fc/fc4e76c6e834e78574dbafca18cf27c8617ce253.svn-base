...
<body bgcolor="#FFFFFF" text="#000000" link="#0000FF" vlink="#0000FF" alink="#FF0000" leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0" onload="SetSID('<?=$_REQUEST['PHPSESSID']?>')">
<table width="100%" height="53" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="27" class="title" nowrap> &nbsp;Administration Console for&nbsp;<?=$_SESSION[$ss]['company_name'].$_SESSION[$ss]['_test']?></td>
  </tr>
</table>
