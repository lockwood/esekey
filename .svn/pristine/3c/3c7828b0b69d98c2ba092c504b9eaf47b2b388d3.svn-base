<?php
// +----------------------------------------------------------------------+
// | EMAIL  - EseSite booking confirmation email formatter - Company 7    |
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id:rjslettings/email.php,v 1.05 2006/01/27
//
...
//  echo $insert; //
    ...
    $trackhdr .= "From: RJSLettings Admin <admin@rjslettings.co.uk>\r\n";
