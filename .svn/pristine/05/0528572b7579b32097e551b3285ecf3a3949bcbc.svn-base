<?php
// +----------------------------------------------------------------------+
// | EMAIL  - EseSite booking confirmation email formatter - Company 6    |
// +----------------------------------------------------------------------+
...
// +----------------------------------------------------------------------+
//
// $Id: 6/email.php,v 1.00 2005/01/12
//
...
/* additional headers */
$headers .= "From: MapleDurham Bookings <bookings@mapledurham.co.uk>\r\n";
$headers .= "Bcc: bookings@esekey.com, dave@esekey.com\r\n";
